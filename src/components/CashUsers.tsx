...
import { cashUsersStyles } from './CashUsersStyles.linaria';
...
const CashUsers = () => {
    ...
    return (
        <div className={ cashUsersStyles }>
            ...
            <div className='cash__users__sort'>
                <div className='cash__users__sort__header'>
                    User sorting:
                </div>

                <div className='cash__users__sort__submitgroup submitgroup'>
                    <button name='sort by name' onClick={ () => store.dispatch(sortUsers('name')) }>By name</button>
                    <button name='sort by cash' onClick={ () => store.dispatch(sortUsers('budget')) }>By cash</button>
                </div>
            </div>
        </div>
    )
